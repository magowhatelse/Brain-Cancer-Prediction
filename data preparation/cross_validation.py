...
# paths 
output_dir = r"C:\Brain Cancer Prediction\data\CSV\5_fold"
plot_path = r"C:\Brain Cancer Prediction\data exploration\plots"


df = pd.read_csv(r"C:\Brain Cancer Prediction\data\CSV/data.csv")
